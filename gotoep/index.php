...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>UNIPMA ADMIN LEARNING SYSTEM</title>
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap nopadding">
				...
				<div class="section nopadding nomargin" style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: url('../images/loginbg.png') center center no-repeat; background-size: cover;"></div>

				<div class="section nobg full-screen nopadding nomargin">
					<div class="container vertical-middle divcenter clearfix">

						<div class="row center">
							<a href="index.php"><img height="50px" src="../images/lokamfoter.png" alt="Unipma Learning"></a>
						</div>
						...
						<div class="row center dark"><small>Copyrights &copy; 2023 All Rights Reserved by UNIPMA Madiun.</small></div>
